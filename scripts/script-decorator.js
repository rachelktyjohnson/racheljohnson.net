...
document.querySelector(".content").addEventListener('mouseover', (e)=>{
    if (e.target.closest('.facet-header')) {
        if (e.target.closest('#designer')){
            ...
            if (!document.querySelector('.flair').classList.contains('showing')){
                anime({
                    targets: '.flair',
                    translateY: [600, 0],
                    duration: 600,
                })
                document.querySelector('.flair').classList.add('showing');
            }
        }
...
//
// document.querySelector('.facet.facet-designer').addEventListener('mouseover', (e)=>{
//
// })
//
// document.querySelector('.facet.facet-designer').addEventListener('mouseout', (e)=>{
//     if (document.querySelector('.flair').classList.contains('showing')){
//         anime({
//             targets: '.flair',
//             translateY: [0, 600],
//             duration: 1000,
//         })
//         document.querySelector('.flair').classList.remove('showing');
//     }
//
// })
